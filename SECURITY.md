...
Replace this section with the supported versions for `typoscope`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `typoscope` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in typoscope.
